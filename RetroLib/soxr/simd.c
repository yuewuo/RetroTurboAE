...
// added by wuyuepku 20190612 to fix compile error on arm64 machine.
#ifndef UNINTERLEAVE2
#define UNINTERLEAVE2(a,b,c,d) { assert(0 && "are you on arm64? see "__FILE__" for more details"); }
#endif
#ifndef INTERLEAVE2
#define INTERLEAVE2(a,b,c,d) { assert(0 && "are you on arm64? see "__FILE__" for more details"); }
#endif
