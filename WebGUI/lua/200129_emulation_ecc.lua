collection = "200204_emulation_ecc_8kbps_8_dense"

packet_cnt = 300
packet_size = 128
--ecc_per_block = 28 -- must be even
--pdata_per_block = 100 -- p for primitive; pdata_per_block + ecc_per_block < 256
ecc_per_block_start = 8
ecc_per_block_end = 8
ecc_per_block_step = 8 -- must be even
...
for i=1,packet_cnt do
    local ecc_per_block = ecc_per_block_start
    while ecc_per_block <= ecc_per_block_end do -- ECC loop
        ...
        ecc_per_block = ecc_per_block + ecc_per_block_step -- update ecc bytes per block
    end
